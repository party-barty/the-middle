...
export default function HomePage() {
  ...
  const [heroFormMode, setHeroFormMode] = useState<'create' | 'join'>('create');
  ...
  // Auto-populate session code from URL if present
  useEffect(() => {
    if (sessionId) {
      setSessionCode(sessionId.toUpperCase());
      setShowJoin(true);
      setShowHeroForm(true);
      setHeroFormMode('join');
    }
  }, [sessionId]);
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-8 text-sm">
              <a
                href="#"
                className="hover:text-lime-300 transition-colors font-medium"
              >
                Privacy
              </a>
              <a
      ...
      <section className="relative min-h-[600px] flex items-center justify-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Stop the endless "where should we meet?" texts. Find the perfect
            spot that's fair for everyone.
          </p>
            ...
            <div className="max-w-md mx-auto">
              {heroFormMode === 'create' ? (
                <Card className="border-none shadow-2xl bg-white/95 backdrop-blur-md">
                  <CardHeader>
                    <CardTitle className="text-2xl bg-gradient-to-r from-lime-600 to-teal-600 bg-clip-text text-transparent">
                      Create a Session
                    </CardTitle>
                    <CardDescription>
                      Start a new meetup and invite friends
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="h-12 px-6 border-2 border-lime-400 hover:bg-lime-50 hover:border-lime-500 text-lime-700"
                      >
                        Back
                      </Button>
                    </div>
                ...
                <Card className="border-none shadow-2xl bg-white/95 backdrop-blur-md">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Enter your name and session code
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <Input
      ...
      <section className="relative py-20 px-4">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-center text-gray-600 mb-16 text-lg">
            Three simple steps to your perfect meetup
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <div className="inline-block px-3 py-1 bg-lime-100 text-lime-700 rounded-full text-sm font-bold mb-3">
                Step 1
              </div>
              ...
              <p className="text-gray-600 text-lg">
                Choose real-time location or manually set where you'll be —
                perfect for planning ahead or coordinating travel.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="inline-block px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm font-bold mb-3">
                Step 2
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                See Your Midpoint
              ...
              <p className="text-gray-600 text-lg">
                We instantly calculate the fair middle point for everyone in
                your group and display it on a shared map.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="inline-block px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-sm font-bold mb-3">
                Step 3
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Swipe to Decide
              ...
              <p className="text-gray-600 text-lg">
                Browse venue recommendations near the midpoint. Swipe right to
                approve, left to skip. When everyone swipes right on the same
                place… you have a match!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105 group overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardTitle className="text-xl bg-gradient-to-r from-lime-600 to-emerald-600 bg-clip-text text-transparent">
                  Flexible Location Input
                </CardTitle>
                <CardDescription className="text-base text-gray-600">
                  Use live GPS or manually set a location. Ideal for planning
                  future trips.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105 group overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardTitle className="text-xl bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">
                  Map-Based Friend View
                </CardTitle>
                <CardDescription className="text-base text-gray-600">
                  See everyone's position on the map with live/manual
                  indicators.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105 group overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardTitle className="text-xl bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">
                  Smart Midpoint Finder
                </CardTitle>
                <CardDescription className="text-base text-gray-600">
                  The fairest place to meet, calculated automatically — with the
                  option to lock it.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105 group overflow-hidden">
              ...
              <CardHeader className="relative">
                <div className="text-5xl mb-3">🍽️</div>
                <CardTitle className="text-xl bg-gradient-to-r from-lime-600 to-green-600 bg-clip-text text-transparent">
            ...
            <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105 group overflow-hidden">
              ...
              <CardHeader className="relative">
                <div className="text-5xl mb-3">🧡</div>
                <CardTitle className="text-xl bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent">
                  Swipe-to-Match
                </CardTitle>
                <CardDescription className="text-base text-gray-600">
                  A fun, familiar swipe interface that leads to quick group
                  decisions.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300 hover:scale-105 group overflow-hidden">
              ...
              <CardHeader className="relative">
                ...
                <CardDescription className="text-base text-gray-600">
                  Everyone sees every update instantly. No accounts required for
                  your first session.
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          <div className="space-y-6 text-left max-w-2xl mx-auto">
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-r from-lime-50 to-emerald-50 border border-lime-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-lg text-gray-700 pt-1">
                <strong className="text-lime-700">Fast group decisions</strong>{" "}
                — no more endless texting or compromising.
              </p>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-lg text-gray-700 pt-1">
                <strong className="text-amber-700">Fair for everyone</strong> —
                midpoint removes the guesswork.
              </p>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-lg text-gray-700 pt-1">
                <strong className="text-teal-700">Great recommendations</strong>{" "}
                — powered by trusted Google data.
              </p>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-r from-lime-50 to-green-50 border border-lime-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-lg text-gray-700 pt-1">
                ...
                — plan ahead using manual locations.
              </p>
            </div>
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-lg text-gray-700 pt-1">
                ...
                — mobile-first, shareable, no app required.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-12 border border-lime-200/50">
            <div className="flex justify-center mb-6">
              <div className="flex gap-1">
                {[...Array(5)].map((_, i) => (
                  <span key={i} className="text-3xl text-amber-400">
                    ⭐
                  </span>
                ))}
              </div>
            ...
            <p className="text-2xl md:text-3xl text-gray-800 italic mb-6 font-medium">
              "We planned a meetup in under 30 seconds. No arguments, no stress
              — just vibes."
            </p>
      ...
      <section id="get-started" className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-8">
            Start planning your perfect meetup in seconds
          </p>
              ...
              <>
                ...
                <Card className="border-none shadow-2xl bg-white/95 backdrop-blur-md hover:scale-105 transition-transform duration-300">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Enter a session code to join friends
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button
